...
//             <div ref={modalRef} className="relative bg-white rounded-xl shadow-xl w-full max-w-2xl max-h-[85vh] overflow-y-auto hide-scrollbar">
...
//                         <label className={`logo-upload-area flex flex-col items-center justify-center w-24 h-24 border-2 border-dashed rounded-full cursor-pointer transition-colors ${
