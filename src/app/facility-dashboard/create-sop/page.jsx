...
export default function SupervisorPage() {
    ...
    const calculateDurationInHours = (minTime, maxTime) => {
        ...
        return (minHours + maxHours) / 2; // Return average duration
    };
        ...
        const transformedStages = stages.map(stage => {
            ...
            const transformedTasks = stageTasks.map(task => {
                const transformedSubtasks = task.subtasks.map(subtask => ({
                    ...
                    image: subtask.photos[0] || '', // Taking first photo if exists
                ...
                return {
                    title: task.title,
                    description: task.description,
                    image: task.photos[0] || '', // Taking first photo if exists
    ...
    const handleSave = () => {
        ...
        console.log("Data ready for backend (matches Mongoose schema):", dataToSave);
