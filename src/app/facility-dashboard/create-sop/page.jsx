                                                ...
                                                <div className="flex gap-2">
                                                    {editingDescription === task.id ? (
                                                        <textarea
                                                            ...
                                                            onBlur={(e) => updateTaskDescription(selectedStage, task.id, e.target.value)}
                                                            onKeyPress={(e) => e.key === 'Enter' && updateTaskDescription(selectedStage, task.id, e.target.value)}
                                                            autoFocus
                                                    ...
                                                    <AttachPhotoButton
                                                        onPhotoSelect={(data) => handlePhotoUpdate(selectedStage, task.id, data)}
                                                        photos={task.photos}
