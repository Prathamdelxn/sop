...
// //                               {task.createdAt ? new Date(task.createdAt).toLocaleString("en-IN", {
// //                                         day: "2-digit",
// //                                         month: "short",
// //                                         year: "numeric",
// //                                         hour: "2-digit",
...
//                         <span className="font-semibold text-green-600">Approved</span>{" "}
//                         By{" "}
//                         {task.approver.approverName || companyData.name}
//                       </div>
//                       <div className="">{task.approver?.approverDate
//                         ? new Date(task.approver.approverDate).toLocaleString()
//                         : "—"}</div>
...
//         console.log("this is fetchall",data.data);
//         const pendingTasks = data.data.filter(
//           (t) => t.companyId === companyData?.companyId && t.status == "Pending Approval" && t.userId != companyData.id
//         );
//         setTasks(pendingTasks);
...
const TaskDetailsModal = ({ task, onClose, onBarcodeUpload, companyData }) => {
  if (!task) return null;
                  ...
                  {task.status === "Approved" ? (
                    <>
                      <div>
                        <span className="font-semibold text-green-600">Approved</span>{" "}
                        By{" "}
                        {task.approver?.approverName || companyData?.name || 'Unknown Approver'}
                      </div>
                      <div className="">
                        {task.approver?.approverDate
                          ? new Date(task.approver.approverDate).toLocaleString()
