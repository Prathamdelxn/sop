...
// //   const renderTableRows = (items, level = 0, parentStage = "", parentTask = "") => {
// //     let rows = [];
// //     items.forEach((item, index) => {
// //       const stageTitle = item.id.startsWith("stage") ? item.title : parentStage;
// //       const taskTitle = item.id.startsWith("task") ? item.title : item.id.startsWith("subtask") ? parentTask : "";
// //       const subtaskTitle = item.id.startsWith("subtask") ? item.title : "";
      
// //       rows.push(
// //         <tr key={item.id} className="border-b border-gray-200 hover:bg-gray-50">
// //           <td className="py-3 px-4 text-sm text-gray-700">{stageTitle}</td>
// //           <td className="py-3 px-4 text-sm text-gray-700">{taskTitle}</td>
// //           <td className="py-3 px-4 text-sm text-gray-700">{subtaskTitle}</td>
// //           <td className="py-3 px-4 text-sm text-gray-600">{item.description || "-"}</td>
// //           <td className="py-3 px-4 text-sm text-gray-600">{item.minTime || "-"}</td>
// //           <td className="py-3 px-4 text-sm text-gray-600">{item.maxTime || "-"}</td>
// //           <td className="py-3 px-4 text-sm text-gray-600">
// //             {item.images && item.images.length > 0
// //               ? `${item.images.length} Image${item.images.length > 1 ? "s" : ""}${item.galleryTitle ? ` - ${item.galleryTitle}` : ""}`
// //               : "-"}
// //           </td>
// //         </tr>
// //       );
...
// //       if (item.tasks) {
// //         rows = [...rows, ...renderTableRows(item.tasks, level + 1, stageTitle, "")];
// //       }
// //       if (item.subtasks) {
// //         rows = [...rows, ...renderTableRows(item.subtasks, level + 1, stageTitle, taskTitle)];
// //       }
// //     });
// //     return rows;
// //   };
...
// //               </tr>
// //             </thead>
// //             <tbody>{renderTableRows(stages)}</tbody>
// //           </table>
// //         </div>
...
// //               className="w-full px-4 py-2 bg-green-600 text-white text-sm font-medium rounded-lg hover:bg-green-700 transition-colors flex items-center justify-center gap-2 mb-4"
// //             >
// //               <svg
// //                 className="w-4 h-4"
// //                 fill="none"
