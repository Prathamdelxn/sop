...
const TaskComponent = React.memo(({
  ...
  onToggleExpansion,
  expandedItems,
  taskNumber = '1.1' // Add taskNumber prop
}) => {
...
const handleSavePrototype = async () => {
  ...
  <Link href="/dashboard/create-prototype" className="flex items-center gap-2 font-semibold text-gray-800 text-lg cursor-pointer">
    <ArrowLeft size={20} />
    <span>Homepage</span>
  </Link>
</button>
