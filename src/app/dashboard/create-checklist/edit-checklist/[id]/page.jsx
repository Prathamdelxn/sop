...
//   const [isEditMode, setIsEditMode] = useState(!!id); // Determine if in edit mode
//   const [isLoading, setIsLoading] = useState(!!id); // Loading state for fetching data
...
//                               <ImageIcon className="w-4 h-4" />
//                               Attach{" "}
//                               {newSubtasks[parentId]?.images?.length || 0} Image
