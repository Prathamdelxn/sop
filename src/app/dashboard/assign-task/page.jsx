                            ...
                            >
                              <div className="flex justify-between items-center">
                                <div>
                                  ...
                                  <p className="text-xs text-gray-500">{member.role} • {member.code}</p>
                                </div>
                                <input
                                  type="checkbox"
...
const AssignmentDetailsModal = () => {
  ...
  //   return (
  //     <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-300/50 bg-opacity-50">
  ...
  //               <ClipboardList className="h-6 w-6 text-indigo-600 mr-2" />
  //               <h2 className="text-xl font-semibold text-gray-800">
  //                 Assignment Details for {viewAssignmentDetails.equipment.name}
  //               </h2>
  //             </div>
  //           </div>
  //         </div>
  ...
  //             <span className="font-medium ">Equipment Name : <span className="font-normal ">{viewAssignmentDetails.equipment.name}</span></span>
  //             <img src={viewAssignmentDetails.equipment.barcode} alt="" />
  //             <h3 className="font-medium text-blue-800 mb-3">Checklist : <span>{viewAssignmentDetails.prototypeData.name}</span></h3>
  //             {stages.map((stage, stageIndex) => (
  //               <div key={stage._id} className="mb-4 last:mb-0">
  //                 <h4 className="font-medium">Stage {stageIndex + 1}: {stage.name}</h4>
  //                 <ul className="mt-2 pl-4 space-y-2">
  //                   {stage.tasks.map((task, taskIndex) => (
  //                     <li key={task._id} className="text-sm text-gray-700 flex justify-between">
  //                       <span>Task {stageIndex + 1}.{taskIndex + 1}: {task.title}</span>
  //                       {task.assignedWorker && (
